...
// const BestSellingCard = ({ onCardClick, onResume }) => {
...
//       onResume(item); // Pass the entire item to the onResume handler
//     } else {
//       console.warn("onResume is not a function");
//     }
//   };
...
//           key={item.id}
//           ref={ref}
//           onClick={() => onCardClick(item.id)} // Call the click handler
...
//           } group hover:shadow-[0_0_10px_3px_rgba(122,86,215,0.6),0_0_15px_5px_rgba(186,186,201,0.4)] hover:scale-105 cursor-pointer`}
//           style={{
...
//           {/* Resume Button */}
//           <button
//             onClick={() => handleResumeClick(item)} // Pass the entire item to handleResumeClick
//             className="mt-4 text-sm text-blue-500 underline hover:text-blue-700 transition-colors duration-200"
//           >
//             Resume
//           </button>
//         </div>
