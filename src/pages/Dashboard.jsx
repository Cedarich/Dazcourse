    ...
    >
      ...
      {currentView === "dashboard" && (
        <>
          <div
            id="section-header"
            className={`px-4 mt-4 max-w-full sm:max-w-[65%] transition-opacity duration-700 ease-in-out ${
          ...
          <div
            className={`px-4 mb-2 max-w-full sm:max-w-[65%] transition-opacity duration-700 ease-in-out ${
              isVisible ? "opacity-100" : "opacity-0"
            }`}
          >
            <Recommendation />
